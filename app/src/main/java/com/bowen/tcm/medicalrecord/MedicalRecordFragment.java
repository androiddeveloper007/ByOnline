package com.bowen.tcm.medicalrecord;
...
import com.bowen.tcm.medicalrecord.activity.MedicalDetailActivity;
...
import com.mob.wrappers.UMSSDKWrapper.User;
...
public class MedicalRecordFragment extends BaseFragment implements ScrollRecyclerView.OnScrollListener, BaseQuickAdapter.RequestLoadMoreListener, HomeMedicalRecordContract.View {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mView = mInflater.inflate(R.layout.fragment_medical_record, null);
    ...
    private void init() {
        ...
        View headView = mInflater.inflate(R.layout.headview_medical_record, null);
        ...
        mNoRecordTv = (TextView) mView.findViewById(R.id.mNoRecordTv);
        mNoRecordLayout = (LinearLayout) mView.findViewById(R.id.mNoRecordLayout);
        mNoRecordTv.setOnClickListener(this);

        LinearLayoutManager layoutManager = new LinearLayoutManager(mActivity);
        mRecyclerView.setLayoutManager(layoutManager);
        mAdapter = new MedicalRecordAdapter(mActivity);
        ...
        mPresenter = new HomeMedicalRecordPresenter(mActivity, this);
        ...
        mAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                RouterActivityUtil.startActivity(mActivity, MedicalDetailActivity.class, bundle);
            }
        });
    ...
    private void updateUI() {
        if (!LoginStatusUtil.getInstance().isLogin()) {
            mNameTv.setText("未登录");
            mChangerUserBtn.setVisibility(View.GONE);
            ...
            ImageLoaderUtil.getInstance().show(mActivity,"", mTitleHeadPortraitImg,R.drawable.man);
            ...
            ImageLoaderUtil.getInstance().show(mActivity, mShowFamilyPicUrl, mHeadPortraitImg,R.drawable.man);
            ImageLoaderUtil.getInstance().show(mActivity, mShowFamilyPicUrl, mTitleHeadPortraitImg,R.drawable.man);
            ...
            case R.id.mNoRecordTv:
                if (LoginStatusUtil.getInstance().isLogin()) {
                    if(UserInfo.getInstance().isBindPhone()){
                        ...
                        RouterActivityUtil.startActivity(mActivity, AddMedicalInfoActivity.class, bundle);
                    }else {
                        RouterActivityUtil.startActivity(mActivity, BindingPhoneActivity.class);
                    }
    ...
    @OnClick({R.id.mTitleBackImg,R.id.mBackImg,R.id.mTitleHeadPortraitImg, R.id.mTitleNameTv,R.id.mAddMedicalRecordImg})
    public void onViewClicked(View view) {
        Bundle bundle = new Bundle();
        switch (view.getId()) {
            case R.id.mTitleBackImg:
            case R.id.mTitleHeadPortraitImg:
            case R.id.mTitleNameTv:
                bundle.putInt(RouterActivityUtil.FROM_TAG, FamilyMemberActivity.FROM_HOMEPAGE_MEDICAL_RECORD);
                RouterActivityUtil.startActivity(mActivity, FamilyMemberActivity.class,bundle);
                break;
    ...
    public void onGetMedicalRecordSuccess(HomeMedicalRecord homeMedicalRecord) {
        ...
        if (pageBean.getTotalCount() != 0 && mAdapter.getData().size() == pageBean.getTotalCount()) {
            View footView = mActivity.getLayoutInflater().inflate(R.layout.view_no_more, null);
