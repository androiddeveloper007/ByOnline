 ...
 */
public class HPFindDoctorDiseaseAdapter extends BaseQuickAdapter<FindDoctorItem> {
    ...
    public HPFindDoctorDiseaseAdapter(Context cxt) {
        super(cxt);
    }

    @Override
    protected int setItemLayout() {
        return R.layout.adapter_hp_find_doctor;
    }
    ...
    protected void convert(BaseViewHolder helper, FindDoctorItem item, int position) {
        ...
        mNameTv.setText(item.getDiseaseName());
    }
}
