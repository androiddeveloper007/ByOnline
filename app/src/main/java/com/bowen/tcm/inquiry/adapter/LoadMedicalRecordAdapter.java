 ...
 */
public class LoadMedicalRecordAdapter extends BaseQuickAdapter<MedicalRecord> {
    ...
    @BindView(R.id.mChooseMediacalRecordImg)
    ImageView mChooseMediacalRecordImg;

    public LoadMedicalRecordAdapter(Context cxt) {
        super(cxt);
    }

    @Override
    protected int setItemLayout() {
        return R.layout.adapter_load_medical_record;
    }

    @Override
    protected void convert(BaseViewHolder helper, MedicalRecord item, final int position) {
        ...
        mChooseMediacalRecordImg.setSelected(item.isChoose());
