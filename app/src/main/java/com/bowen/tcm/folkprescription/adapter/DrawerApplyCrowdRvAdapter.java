 ...
 */
public class DrawerApplyCrowdRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private LayoutInflater mLayoutInflater;
    private Context context;
    private List<ShowApplyCrowd> list;
    ...
    public DrawerApplyCrowdRvAdapter(Context cxt, List<ShowApplyCrowd> list, int limitCount) {
        this.context = cxt;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ((ItemViewHolder) holder).mContentTv.setText(list.get(position).getApplyName());
