...
/**
 * Describe:解决竖向与横向RecyclerView冲突的RecyclerView
 * Created by AwenZeng on 2018/8/29.
 */
public class FixConflictRecyclerView extends RecyclerView {
    ...
    public FixConflictRecyclerView(Context context) {
        this(context, null);
    }

    public FixConflictRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixConflictRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
